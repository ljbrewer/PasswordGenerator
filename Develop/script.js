...
if ((upcase) === "yes") {
  ...
  console.log ("how many items chosen " + typeofitems);
}
if ((lowcase) === "yes") {
  typeofitems = typeofitems + 1 ;
  console.log ("how many items chosen " + typeofitems);
...
if (((passlength%typeofitems)) != 0) {
  console.log(passlength%typeofitems +" is the remainder");
  console.log(passlength/typeofitems +" is the division");
  console.log(passlength  +" is the requested");
